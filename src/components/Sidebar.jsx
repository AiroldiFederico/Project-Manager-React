...
export default function Sidebar({proj}) {
	return <section className="h-full mt-14 fixed top-0 left-0 w-80 bg-stone-800 text-white rounded-tr-3xl p-6 flex gap-8 flex-col">
